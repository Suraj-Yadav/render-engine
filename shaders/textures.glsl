...
vec2 getMetallicRoughnessUV() {
	vec3 uv =
		vec3(u_MetallicRoughnessUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getClearcoatRoughnessUV() {
	vec3 uv =
		vec3(u_ClearcoatRoughnessUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getClearcoatNormalUV() {
	vec3 uv =
		vec3(u_ClearcoatNormalUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getSheenRoughnessUV() {
	vec3 uv =
		vec3(u_SheenRoughnessUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getIridescenceThicknessUV() {
	vec3 uv = vec3(
		u_IridescenceThicknessUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getDiffuseTransmissionUV() {
	vec3 uv =
		vec3(u_DiffuseTransmissionUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
...
vec2 getDiffuseTransmissionColorUV() {
	vec3 uv = vec3(
		u_DiffuseTransmissionColorUVSet < 1 ? v_texcoord_0 : v_texcoord_1, 1.0);
