...
layout(location = TEXTURECOORDINATES_ATTRIBUTE_LOCATION) in vec2 a_texcoord_0;
#endif
...
layout(location = COLOR_ATTRIBUTE_LOCATION) in vec3 a_color_0;
out vec3 v_Color;
#endif

#ifdef HAS_COLOR_0_VEC4
layout(location = COLOR_ATTRIBUTE_LOCATION) in vec4 a_color_0;
out vec4 v_Color;
#endif

#ifdef USE_INSTANCING
layout(location = TRANSFORMATION_MATRIX_ATTRIBUTE_LOCATION) in mat4 a_instance_model_matrix;
#endif
